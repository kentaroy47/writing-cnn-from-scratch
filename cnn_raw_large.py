...
from cnn_param_large import DeepConvNet
...
model.load_weights("./model/param_large.hdf5")

W1=model.layers[0].get_weights()
W2=model.layers[2].get_weights()
W3=model.layers[3].get_weights()
W4=model.layers[5].get_weights()
W5=model.layers[6].get_weights()
W6=model.layers[8].get_weights()
W7=model.layers[9].get_weights()
W8=model.layers[12].get_weights()
##########################
##start frame work########
##########################
...
W3[0] = W3[0].transpose([3,2,0,1])
W4[0] = W4[0].transpose([3,2,0,1])
W5[0] = W5[0].transpose([3,2,0,1])
W6[0] = W6[0].transpose([3,2,0,1])
W7[0] = W7[0].transpose([3,2,0,1])


network = DeepConvNet(W1,W2,W3,W4,W5,W6,W7,W8)  
