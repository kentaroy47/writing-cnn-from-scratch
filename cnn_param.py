...
class DeepConvNet:
    ...
    """
    def __init__(self, W1, W2, W3, W4, W5, input_dim=(3, 32, 32),
                 conv_param_1 = {'filter_num':64, 'filter_size':6, 'pad':2, 'stride':2},
                 conv_param_2 = {'filter_num':128, 'filter_size':3, 'pad':1, 'stride':2},
                 conv_param_3 = {'filter_num':128, 'filter_size':3, 'pad':1, 'stride':2},
                 output_size=10):
        # 重みの初期化===========
...
#        self.layers.append(Pooling(pool_h=2, pool_w=2, stride=2)) #2
        ...
        self.layers.append(Convolution(self.params['W3'], self.params['b3'], 
                           conv_param_3['stride'], conv_param_3['pad'])) #5
        self.layers.append(Relu()) #6
#        self.layers.append(Pooling(pool_h=2, pool_w=2, stride=2)) #7
        
#        self.layers.append(Flatten())
        self.layers.append(Affine(self.params['W4'], self.params['b4'])) #8
        self.layers.append(Relu())
        self.layers.append(Affine(self.params['W5'], self.params['b5'])) #8
